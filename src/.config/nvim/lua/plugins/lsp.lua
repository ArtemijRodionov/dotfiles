	...
	{'VonHeikemen/lsp-zero.nvim', branch = 'v3.x',
		...
		config = function()
			...
			lsp_zero.on_attach(function(client, bufnr)
				...
				vim.keymap.set("n", "K", function() vim.lsp.buf.hover() end, opts("Hover", default))
				...
				vim.keymap.set("n", "<C-h>", function() vim.lsp.buf.signature_help() end, opts("Help", default))
				vim.keymap.set("n", "<leader>ld", function() vim.lsp.diagnostic.open_float() end, opts("Diagnostic", default))
